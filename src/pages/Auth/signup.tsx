                    ...
                    <a href="#" className="flex justify-end mt-2 font-semibold text-gray-600 hover:text-black">
                      Forgot password?
						...
						<div>
							<button
								type="submit"
								className="mt-5 flex w-full justify-center rounded-md bg-gray-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-black focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
							>
								Sign up
							</button>
						</div>
