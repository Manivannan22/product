...
const Main = () => {
  ...
  return (
    ...
    //   <HoverCard>
    //     <HoverCardTrigger>
    // <Card className="w-[200px]  hover:bg-slate-50 shadow-lg"  onClick={handleClick}>
    //   <CardHeader>
    //     <img className="h-56" src="https://rukminim2.flixcart.com/image/612/612/xif0q/external-hard-drive/ssd/y/s/7/sdssde30-1t00-g26-sandisk-original-imagsgpmhcxmsxet.jpeg?q=70" />
    //     {/* <CardTitle className="mt-10">Create project</CardTitle> */}
    //     <CardDescription className="text-blue-400">Portable 4-Port USB.</CardDescription>
    //   </CardHeader>
    //   <CardContent>
